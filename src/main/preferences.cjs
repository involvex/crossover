...
import { debugInfo } from './util.mjs'
...
const browserWindowOverrides = {
	...
	// height: 400,
	webPreferences: {
		devTools: electronUtil.is.development && SETTINGS_WINDOW_DEVTOOLS,
	},
}
...
const preferencesConfig = {
	...
	debug: electronUtil.is.development && !electronUtil.is.linux,
				...
				groups: [
					{
						...
						fields: [
							{
								content:
									'<p>Use <code>CTRL+ALT+SHIFT+X</code> to lock CrossOver in place and hide the background window.</p>',
								type: 'message',
							},
						],
					},
					{
						...
						fields: [
							...
							},
							{
								...
								options: [
									{
										label: 'Apply customization options to SVG images',
										value: 'svgCustomization',
									},
								],
				...
				groups: [
					{
						...
						fields: [
							{
								content:
									'<p><b>Note:</b> CrossOver Actions do not work on Apple Silicon.</p>',
								type: 'message',
							},
						],
					},
						...
						fields: [
							{
								...
								options: [
									{
										label: 'Lock the crosshair to the mouse cursor',
										value: 'followMouse',
									},
								],
							...
							},
							{
								...
								options: [
									{
										label:
											'On ADS, toggle hiding/showing the Crosshair (vs hold)',
										value: 'hideOnMouseToggle',
									},
								],
					...
					},
					{
						...
						fields: [
							...
							},
							{
								...
								options: [
									{
										label: 'Enable tilting left/right on keypress',
										value: 'tiltEnable',
									},
								],
							...
							},
							{
								...
								options: [
									{
										label: 'Toggle tilt on/off when pressed (instead of hold)',
										value: 'tiltToggle',
									},
								],
				...
				groups: [
					{
						...
						fields: [
							{
								content:
									'<p>You can clear or disable a keybind completely by using Backspace/Delete.</p><p>Use <code>CTRL+ALT+SHIFT+R</code> to reset all settings.</p>',
								type: 'message',
							},
						],
					},
				...
				groups: [
					{
						...
						fields: [
							...
							},
							{
								...
								options: [
									{
										label: 'Allow CrossOver to automatically update',
										value: 'updates',
									},
								],
							...
							},
							{
								...
								options: [
									{
										label: 'Unlock and show CrossOver window on startup',
										value: 'startUnlocked',
									},
								],
							...
							},
							{
								...
								options: [
									{
										label: 'Allow CrossOver to create system notifications',
										value: 'notify',
									},
								],
							...
							},
							{
								...
								options: [
									{
										label: 'Receive information from the developer',
										value: 'alerts',
									},
								],
							...
							},
							{
								...
								options: [
									{
										label:
											'This switch runs the GPU process in the same process as the browser',
										value: 'gpuprocess',
									},
								],
							...
							},
							{
								...
								fields: [
									{
										content:
											'<p>This will completely remove any customizations made to the settings and reset them to d</p>',
										type: 'message',
									},
								],
							},
						...
						fields: [
							{
								...
								content: `\n\t								<p>A crosshair overlay for any screen.<br /> \n									Feedback and bug reports welcome at <a target="_blank" href="https://github.com/involvex/crossover/issues">involvex/crossover</a>.<br /> \n									Developed by Involvex.</p> \n									<p>Copyright © involvex ${new Date().getFullYear()}</p> \n									<p>${debugInfo()}</p> \n									<br/> \n									<p>Looking for a designer!<br />We want to redesign CrossOver \n									for details.</p>\n								\t								`,
								type: 'message',
							},
						],
					},
