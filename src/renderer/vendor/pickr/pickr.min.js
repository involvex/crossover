		...
		(function (t) {
			...
			function (t, e, o) {
				...
				(o.r(n),
					o.d(n, "on", () => r),
					o.d(n, "off", () => s),
					o.d(n, "createElementFromString", () => a),
					o.d(n, "createFromTemplate", () => l),
					o.d(n, "eventPath", () => c),
					o.d(n, "resolveElement", () => p),
					o.d(n, "adjustableInputNumbers", () => u));
				const r = i.bind(null, "addEventListener");
				const s = i.bind(null, "removeEventListener");
				function a(t) {
				...
				function A(t) {
					t = t.match(/^[a-zA-Z]+$/)
						? (function (t) {
								...
								return (
									(e.fillStyle = t),
									e.fillStyle === "#000" ? null : e.fillStyle
								);
							})(t)
						: t;
					const e = {
					...
					t: for (const i in e) {
						...
						const r = (t) => Boolean(n[2]) == (typeof t === "number");
						switch (i) {
							case "cmyk": {
								const [, t, e, r, s] = o(n);
				...
				function $(t) {
					const e = {
						options: { lock: null, onchange: () => 0, onstop: () => 0, ...t },
						_keyboard(t) {
							const { options: o } = e;
							...
							if (document.activeElement === o.wrapper) {
								...
								const r = i === "ArrowUp";
								const s = i === "ArrowRight";
								const a = i === "ArrowDown";
								const l = i === "ArrowLeft";
								if (n === "keydown" && (r || s || a || l)) {
									let n = 0;
									let i = 0;
									(o === "v"
										? (n = r || s ? 1 : -1)
						...
						_tapmove(t) {
							...
							const { lock: i, element: r, wrapper: s } = o;
				...
				function S(t = {}) {
					t = { onchange: () => 0, className: "", elements: [], ...t };
				...
				const E = (t, e, o) => {
					const n =
						typeof t !== "object" || t instanceof HTMLElement
					...
					return {
						update(t = n) {
							...
							return ((t, e, o) => {
								...
								const [f, m = "middle"] = r.split("-");
								const v = a[f];
								const b = s[m];
								const { top: g, left: y, bottom: _, right: w } = n;
								for (const t of v) {
									const o = t === "t" || t === "b";
									const n = h[t];
									const [i, r] = o ? ["top", "left"] : ["left", "top"];
									const [s, a] = o ? [u.height, u.width] : [u.width, u.height];
									const [l, c] = o ? [_, w] : [w, _];
									const [p, f] = o ? [g, y] : [y, g];
									if (!(n < p || n + s > l)) {
										for (const s of b) {
				...
				class x {
					constructor(t) {
						(L(this, "_initializingActive", !0),
							...
							(this.options = t = { ...x.DEFAULT_OPTIONS, ...t }));
						const {
							swatches: e,
							components: o,
							theme: n,
					...
					_preBuild() {
						...
						((this._root = ((t) => {
							...
							const a = (t) => (t ? "" : 'style="display:none" hidden');
							const c = (e) => t._t(e);
							const p = l(
					...
					_buildComponents() {
						...
						const o = (t.options.sliders || "v").repeat(2);
						const [n, i] = o.match(/^[vh]+$/g) ? o : [];
						const r = () =>
						...
						const s = {
							palette: $({
								...
								onchange(o, n) {
									...
									const i = r();
									const { _root: s, options: a } = t;
									const { lastColor: l, currentColor: c } = s.preview;
									t._recalc &&
										((i.s = 100 * o),
										(i.v = 100 - 100 * n),
										i.v < 0 && (i.v = 0),
												...
												? ((t = setTimeout(() => (t = null), 100)),
													requestAnimationFrame(function e() {
														(n._rePositioningPicker(),
															t !== null && requestAnimationFrame(e));
													}))
												: (clearTimeout(t),
													(t = setTimeout(() => (t = null), 100))));
									},
					...
					_parseLocalColor(t) {
						...
						const { lockOpacity: i } = this.options;
						const r = void 0 !== n && n !== 1;

						return (
							e && e.length === 3 && (e[3] = void 0),
					...
					addSwatch(t) {
						...
						if (e) {
							...
							const n = C(...e);
							const i = a(
								`<button type="button" style="color: ${n.toRGBA().toString(0)}" aria-label="${this._t("btn:swatch")}"/>`,
							);
					...
					applyColor(t = !1) {
						...
						const n = this._color.toRGBA().toString(0);
					...
					setColor(t, e = !1) {
						...
						if (o) {
							...
							const { options: i } = this._root.interaction;
							const r = i.find((e) => e.getAttribute("data-type") === t);
							if (r && !r.hidden) {
								for (const t of i) {
							...
							return (
								Boolean(this.setHSVA(...o, e)) && this.setColorRepresentation(t)
							);
						}
