!(function (e, n) {
	...
	(function (e) {
		...
		function (e, n, i) {
			...
			const l = i(19);
			const r = i(17);
			const o = t["__core-js_shared__"] || l("__core-js_shared__", {});
			(e.exports = function (e, n) {
		...
		function (e, n, i) {
			...
			n.default = Object.keys(l.default)
				.map((e) => new t.default(e, l.default[e], r.default[e]))
				.reduce((e, n) => ((e[n.name] = n), e), {});
		},
		function (e, n) {
			e.exports = [
				"constructor",
...
*/
		...
		function (e, n, i) {
			...
			(l("inspectSource", (e) => c.call(e)),
				(e.exports = function (e, n, i, l) {
					const c = Boolean(l) && Boolean(l.unsafe);
					let p = Boolean(l) && Boolean(l.enumerable);
					const y = Boolean(l) && Boolean(l.noTargetGet);
					(typeof i === "function" &&
			...
			const c = (function () {
				function e(n, i) {
					...
					(!(function (e, n) {
						...
						(this.contents = i),
						(this.tags = l),
						(this.attrs = { ...o.default, class: "feather feather-" + n }));
				}
		...
		function (e, n, i) {
			const t = i(4);
			e.exports =
				Boolean(Object.getOwnPropertySymbols) && !t(() => !String(Symbol()));
		},
		function (e, n, i) {
			const t = i(4);
			e.exports = !t(() => {
		...
		function (e, n, i) {
			...
			const r = function (e, n) {
				...
				return (
					i == p || (i != c && (typeof n === "function" ? t(n) : Boolean(n)))
				);
			};
		...
		function (e, n, i) {
			...
			const l = i(30);
			const r = "".split;
			e.exports = t(() => !Object("z").propertyIsEnumerable(0))
				? function (e) {
				...
				if (
					(j &&
						...
						u !== Object.prototype &&
							...
							(h ||
								r(w) === u ||
								(o ? o(w, u) : typeof w[f] !== "function" && c(w, f, g)),
							a(w, A, !0, !0),
							h && (x[A] = g))),
					s == "values" &&
						V &&
